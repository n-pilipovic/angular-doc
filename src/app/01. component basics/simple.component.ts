...
/* We use this module to highlight the basics that you need to know
about components. There will be a separate modules where you can learn
how component lifecycle works, how to communicate between child and parent component
and how to do routing etc. */
...
export class SimpleComponent implements OnInit {
  ...
  arrayOfNames = ['First', 'Second', 'Third', 'Fourth'];
  ...
  it is recommended that you do initialization logic in ngOnInit lifecycle hook instead. In that case you can be sure that the
    component has initialized and you have access to everything. It is recommended to use constructor only for dependency injection.
  ...
  // this is how you create a method and provide it's return type. We use this in the template.
  displayWarning(): boolean {
    return true;
  }

  /* return type void means that nothis is returned. We use this method from the template. */
