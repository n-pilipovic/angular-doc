...
describe('SimpleComponent', () => {
  ...
  it('should display the warning when displayWarning() returns true', () => {
    ...
    const warningElement = fixture.debugElement.query(By.css('[data-warning]')).nativeElement;
  ...
  it('should display default text when displayWarning() returns false', () => {
    ...
    fixture.detectChanges();
    const noWarningElement = fixture.debugElement.query(By.css('[data-no-warning]')).nativeElement;
  ...
  it('should call displayNameIndex with the correct index when user clicks on button', () => {
    ...
    secondButtonInList.click(); // this is how we imitate an user action on an element
